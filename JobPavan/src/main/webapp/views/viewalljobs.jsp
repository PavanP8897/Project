...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">Pavan Job Portal Web App</a>
...
<!-- Use c:set to correctly set the jobPosts -->
